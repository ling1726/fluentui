...
storiesOf('RangedSlider ', module)
  ...
  .addStory('Disabled', () => <RangedSlider className="test-class" defaultValue={[15, 58]} disabled />, {
    includeHighContrast: true,
    includeDarkMode: true,
  })
  ...
  .addStory('Marks', () => <RangedSlider className="test-class" max={10} defaultValue={[1, 8]} marks />, {
    includeRtl: true,
    includeHighContrast: true,
    includeDarkMode: true,
  })
  ...
  .addStory(
    'Marks Custom',
    () => <RangedSlider className="test-class" max={10} defaultValue={[1, 8]} marks={[0, 1, 5, 8, 10]} />,
    {
      includeRtl: true,
    },
  )
  .addStory(
    ...
    () => <RangedSlider className="test-class" vertical max={10} defaultValue={[1, 8]} marks={[0, 1, 5, 8, 10]} />,
    {
      includeRtl: true,
    },
  )
